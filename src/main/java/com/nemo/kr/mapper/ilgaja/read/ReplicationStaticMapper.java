...
public interface ReplicationStaticMapper {
	...
	public List<OrderStatisticsDTO> selectCompanyList(OrderStatisticsDTO orderStatisticsDTO);
	...
	public List<UseStatisticsDTO> selectUseStatisticsCompanyList(UseStatisticsDTO useStatisticsDTO);
	...
	public List<AccountDTO> selectSystemFeeTaxList(AccountDTO accountDTO);
	
	public List<AccountDTO> selectRunningRoyaltyTaxList(AccountDTO accountDTO);
}
