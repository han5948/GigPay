			...
			<tbody>
				...
				<c:if test="${boardGroup.email_yn eq '1' }">
					<tr>
						<th scope="col">이메일</th>
						<td>
							<input type="text" id="board_email" name="board_email" class="notEmpty email" value="${resultDTO.board_email }" title="이메일">
							${boardDTO.board_email }
						</td>
					</tr>
				</c:if>
				<c:if test="${boardGroup.phone_yn eq '1' }">
					<tr>
						...
						<td>
							<input type="text" id="board_phone" name="board_phone" class="notEmpty tel" value="${resultDTO.board_phone }" title="휴대폰번호">
						</td>
					</tr>
				</c:if>
				<c:if test="${boardGroup.pass_yn eq '1' }">
					<tr>
						...
						<td>
							<input type="text" name="board_pass" id="board_pass" maxlength="100" class="notEmpty" value="${resultDTO.board_pass}" title="패스워드" />
						</td>
					</tr>    
				</c:if>
