...
<script type="text/javascript">
	...
	function editProcess() {
		if ( fnChkValidForm('frmReg') ) {
			$('#frmReg').ajaxForm({
					url : "/system/code/codeEditProcess",
					dataType : "json",
...
<form id="frmReg" name="frmReg" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
	...
	<div class="content">
		...
		<table border="1" style="width:80%;margin-top:10px" >
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="codeType" id="codeType" maxlength="100" class="input00 notEmpty" value="${resultDTO.codeType}" title="코드타입" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="codeRank" id="codeRank" maxlength="100" class="input00 notEmpty" value="${resultDTO.codeRank}" title="rank" />
					</td>
				</tr>
		...
		<div class="btn_base" >
			...
			<a class="btn mod r" href="javascript:void(0);" id="editCode">저장</a>
		</div>
	</div>
